...
data modify storage arr_math:in var1 set value {dec:18,num:[4,4,1,5,0,1,6,9,9,3,8,8,0,2,7,2,8],pol:-1,base:10}
...
data modify storage arr_math:in var1 set value {dec:17,num:[8,4,1,9,9,8,0,1,0,8,7,3,7,9,4,5],pol:1,base:10}
...
data modify storage arr_math:in var1 set value {dec:18,num:[1,1,3,3,5,8,0,0,4,0,1,8,6,6,4,3,6],pol:-1,base:10}
...
data modify storage arr_math:in var1 set value {dec:17,num:[4,4,4,0,8,5,7,8,4,2,5,6,4,5,8,2],pol:-1,base:10}
...
data modify storage arr_math:in var1 set value {dec:18,num:[1,1,0,4,5,3,2,8,3,4,1,4,2,4,4,6,4],pol:1,base:10}
...
data modify storage arr_math:in var1 set value {dec:17,num:[1,9,0,9,8,1,8,2,0,2,2,5,7,1,5,6,4],pol:1,base:10}
...
data modify storage arr_math:in var1 set value {dec:18,num:[3,5,7,2,9,7,9,5,6,9,4,3,5,1,1,9,6],pol:-1,base:10}
...
data modify storage arr_math:in var1 set value {dec:17,num:[8,2,3,6,4,0,8,2,3,3,6,4,2,5,7,8],pol:1,base:10}
...
data modify storage arr_math:in var1 set value {dec:16,num:[2,0,2,9,6,0,5,3,5,8,8,3,9,0,3,5],pol:-1,base:10}
...
data modify storage arr_math:in var1 set value {dec:17,num:[3,0,0,0,5,8,3,1,2,7,1,4,0,9,9,9],pol:-1,base:10}
